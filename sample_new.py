...
from sampler_new import get_samples
...
def main(args):
    ...
    train_loader = get_cifar100_dataloaders(batch_size=args.input_size[0], is_instance=True) #get_cifar100_dataloaders_cls(batch_size=args.input_size[0])

    # call sampler to generate data
    data = get_samples(t_model, s_model, train_loader, args, args.class_num,
                       args.sample_num, args.threshold,
